...
?>
<div
    id="<?php echo e(e($settings['container_id'])); ?>"
    class="<?php echo e(e($containerClassComputed)); ?>"
    data-kv-widget="<?php echo e(e($widget->public_token)); ?>"
    data-widget-items="<?php echo e($items->count()); ?>"
>
    <style>
        #<?php echo e(e($settings['container_id'])); ?> {
            width: 100% !important;
        ...
        #<?php echo e(e($settings['container_id'])); ?> > div {
            width: 100% !important;
            max-width: 100% !important;
            display: block !important;
        }
        #<?php echo e(e($settings['container_id'])); ?> .kv-widget-slider {
            width: 100% !important;
            max-width: 100% !important;
            padding-left: 56px;
            padding-right: 56px;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .kv-widget-slide .p-in-in > a {
            text-decoration: none;
            height: 158px;
        }
        #<?php echo e(e($settings['container_id'])); ?> .p a.image {
            height: 150px;
            margin-bottom: 5px;
        }
        #<?php echo e(e($settings['container_id'])); ?> .p a.image img[data-role="product-image"] {
            height: 150px !important;
            margin-bottom: 5px !important;
        }
        #<?php echo e(e($settings['container_id'])); ?> .kv-widget-viewport {
            width: 100% !important;
            max-width: 100% !important;
            overflow-x: auto;
            overflow-y: hidden;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .kv-widget-track {
            width: max(100%, calc((300px + 24px) * <?php echo e(max(1, min(8, $items->count()))); ?>));
            max-width: none;
        }
        #<?php echo e(e($settings['container_id'])); ?> .kv-widget-slide {
            scroll-snap-align: start;
        }
        #<?php echo e(e($settings['container_id'])); ?> .tags .tag::before,
        #<?php echo e(e($settings['container_id'])); ?> .tags .tag::after,
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value::before,
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value::after {
            content: none !important;
            display: none !important;
        }
        #<?php echo e(e($settings['container_id'])); ?> .tags .tag {
            margin-right: 2px;
            border-radius: 5px;
            background: #F3F3F3;
            padding: 4px 6px;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .tags {
            list-style: none;
            display: flex;
            flex-wrap: wrap;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .tags .kv-widget-tag-highlight {
            transform: translateY(-2px);
        }
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-wrapper {
            width: 100% !important;
            bottom: 80px;
        }
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list {
        ...
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value {
            list-style: none;
            padding: 0 !important;
            margin: 0;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .kv-widget-slide .widget-parameter-value a {
        ...
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value a {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            text-align: center;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value.active-variant a {
            background: #259B63;
            color: #ffffff;
            border-color: #259B63;
        }
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value + .widget-parameter-value a {
            border-left-width: 0;
        }
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value:first-child a {
            border-top-left-radius: 24px;
            border-bottom-left-radius: 24px;
            border-left-width: 1px;
        }
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value:last-child a {
            border-top-right-radius: 24px;
            border-bottom-right-radius: 24px;
        }
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-list .widget-parameter-value:only-child a {
            border-radius: 24px;
        }
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-wrapper ul li:before,
        #<?php echo e(e($settings['container_id'])); ?> .tags li:before,
        #<?php echo e(e($settings['container_id'])); ?> .p .product ul li:before {
            content: none !important;
            display: none !important;
        }
        #<?php echo e(e($settings['container_id'])); ?> .widget-parameter-wrapper ul li::after,
        #<?php echo e(e($settings['container_id'])); ?> .tags li::after,
        #<?php echo e(e($settings['container_id'])); ?> .p .product ul li::after {
            content: none !important;
            display: none !important;
        }
        #<?php echo e(e($settings['container_id'])); ?> .p .tags {
            gap: 0;
        }
        #<?php echo e(e($settings['container_id'])); ?> .kv-widget-slider-dot.is-active {
            background: #1fb56b !important;
            border-color: #1fb56b !important;
        }
        #<?php echo e(e($settings['container_id'])); ?> .product-appendix.category-appendix {
            display: block;
            margin: 0 auto 0;
            font-size: 14px;
            font-weight: 500;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .product-appendix.category-appendix .changable {
            display: inline;
        }
        #<?php echo e(e($settings['container_id'])); ?> .brx-product .product-appendix.category-appendix {
            font-size: 14px;
            color: #757575;
            font-weight: 300;
        }
        #<?php echo e(e($settings['container_id'])); ?> .product-appendix.category-appendix .changable strong {
            display: flex;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .product-appendix.category-appendix .changable strong .inspired-brand {
            text-transform: uppercase;
            font-size: 18px;
        }
        #<?php echo e(e($settings['container_id'])); ?> .product-appendix.category-appendix .changable strong .inspired-title {
            text-transform: none;
        }
        #<?php echo e(e($settings['container_id'])); ?> .match-reasons {
            list-style: none;
            display: flex;
            flex-wrap: wrap;
            justify-content: center;
        ...
        #<?php echo e(e($settings['container_id'])); ?> .match-reasons .reason {
        ...
        #<?php echo e(e($settings['container_id'])); ?> .kv-widget-heading {
            margin: 0 0 12px 0;
            font-size: 20px;
            font-weight: 700;
            color: #000;
    ...
    <?php if(!empty($heading ?? '')): ?>
        <h3 class="kv-widget-heading"><?php echo e(e($heading)); ?></h3>
    <?php endif; ?>
        ...
        <div class="kv-widget-slider" style="position: relative; width: 100%; box-sizing: border-box; display: flex; align-items: stretch;">
            ...
            <div class="kv-widget-viewport" style="flex: 1 1 auto; width: 100%; overflow-x: auto; overflow-y: hidden;">
                ...
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(($item['mode'] ?? null) === 'raw'): ?>
                        <?php echo $item['raw_html']; ?>
                    ...
                    <div class="kv-widget-slide" style="flex: 0 0 auto; display: flex; justify-content: center;">
                        <div
                            ...
                            product-master-id="<?php echo e(e($metadata['product_master_id'] ?? $item['item_id'] ?? '')); ?>"
                            product-master-title="<?php echo e(e($metadata['product_master_title'] ?? $defaultTitle)); ?>"
                            variant-id="<?php echo e(e($defaultVariantId ?? $metadata['variant_id'] ?? '')); ?>"
                            variant-title="<?php echo e(e($buyButton['variant_title'] ?? $defaultTitle)); ?>"
                            ...
                            data-widget-item="1"
                            data-default-image="<?php echo e(e($defaultImage ?? '')); ?>"
                            data-default-mini-image="<?php echo e(e($defaultMiniImage ?? '')); ?>"
                            data-default-price="<?php echo e(e($priceCurrentDisplay ?? '')); ?>"
                            data-default-original-price="<?php echo e(e($priceOriginalDisplay ?? '')); ?>"
                            data-default-volume="<?php echo e(e($productVolumeLabel ?? '')); ?>"
                            data-default-discount="<?php echo e(e($discountDisplay ?? '')); ?>"
                            data-default-discount-percent="<?php echo e(e($priceDiscountPercent ?? '')); ?>"
                            data-default-detail-url="<?php echo e(e($defaultDetailUrl)); ?>"
                            data-default-title="<?php echo e(e($defaultTitle)); ?>"
                            data-default-original-name="<?php echo e(e($defaultInspiredTitle ?? '')); ?>"
                            data-title-color="<?php echo e(e($defaultTitleColor ?? '')); ?>"
                            data-appendix-background="https://www.krasnevune.cz/user/documents/upload/<?php echo e($backgroundSuffix); ?>_bg_p.svg"
                            data-default-gender="<?php echo e(e($defaultGender ?? '')); ?>"
                            data-default-gender-icon="<?php echo e(e($defaultGenderIcon ?? $genderIconPath)); ?>"
                            data-default-inspired-brand="<?php echo e(e($defaultInspiredBrand ?? '')); ?>"
                            data-default-inspired-title="<?php echo e(e($defaultInspiredTitle ?? '')); ?>"
                            data-default-variant-code="<?php echo e(e($defaultVariantCode ?? '')); ?>"
                            data-active-variant-id="<?php echo e(e($defaultVariantId ?? '')); ?>"
                            data-default-subtitle="<?php echo e(e($defaultSubtitle ?? '')); ?>"
                            data-default-appendix-style="<?php echo e(e($appendixInlineStyle)); ?>"
                            data-highlight-gender="<?php echo e(!empty($metadata['highlight_gender']) ? '1' : '0'); ?>"
                            data-highlight-tags="<?php echo e(e(implode('|', $metadata['highlight_tags'] ?? []))); ?>"
                        >
                            <div class="p" data-micro="product" data-testid="productItem" style="justify-content: space-between; margin: 0 auto; display: flex; flex-direction: column; height: 100%; position: relative;">
                                <a href="<?php echo e(e($defaultDetailUrl)); ?>" class="image" style="display: block; position: relative; text-align: center;">
                                    <?php if(!empty($defaultGenderIcon ?? $genderIconPath)): ?>
                                        <img src="<?php echo e(e($defaultGenderIcon ?? $genderIconPath)); ?>" class="gender_img_icon" style="position: absolute;" width="40" loading="lazy" alt="">
                                    <?php endif; ?>
                                    <?php if($defaultImage): ?>
                                        <img src="<?php echo e(e($defaultImage)); ?>" fetchpriority="low" loading="lazy" data-role="product-image" style="height: 185px; margin-bottom: 18px;" alt="<?php echo e(e(strip_tags($defaultTitle))); ?>">
                                    <?php endif; ?>
                                    <div style="left: 0; position: absolute; top: 0;">
                                        <span class="brx-flag-action" style="display: <?php echo e($showDiscount ? 'block' : 'none'); ?>; border-radius: 50px; text-transform: uppercase; font-weight: 400; font-size: 10px; background-color: #cd3e96; padding: 4px 10px; color: #fff;">Akce</span>
                                    </div>
                                    <?php if($defaultMiniImage && ! $isBanned): ?>
                                        <div class="mini-original-parfume" data-role="mini-wrapper">
                                            <img src="<?php echo e(e($defaultMiniImage)); ?>" loading="lazy" data-role="mini-image" alt="">
                                        </div>
                                    <?php endif; ?>
                                </a>
                                <?php if(!empty($tagLabels)): ?>
                                    <ul class="tags">
                                        <?php $__currentLoopData = $tagLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $labelIndex => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($labelIndex < 3): ?>
                                                <li class="tag"><?php echo e(e($label)); ?></li>
                                            <?php endif; ?>
                                ...
                                <div class="p-in">
                                    <div class="p-in-in" style="margin-top: 15px;">
                                        <a href="<?php echo e(e($defaultDetailUrl)); ?>" class="name" data-micro="url" style="border-bottom: 0; font-weight: 400; display: block; text-align: center;">
                                            <span data-micro="name" data-testid="productCardName" style="color: <?php echo e($defaultTitleColor ?? ($defaultGender === 'female' ? 'rgb(214, 52, 90)' : ($defaultGender === 'male' ? 'rgb(52, 97, 214)' : 'black'))); ?>">
                                                <span data-role="product-name-text"><?php echo e(Str::limit(strip_tags($defaultTitle), 30, '...')); ?></span>
                                                <span class="product-appendix category-appendix" style="<?php echo e($appendixInlineStyle); ?>">
                                                    <?php echo e(e($defaultSubtitle)); ?>
                                                    ...
                                                    ?>
                                                    <?php if($shouldShowInspiration): ?>
                                                        <span class="changable">, zaměňována s:<br>
                                                            <strong style="background-image: url('https://www.krasnevune.cz/user/documents/upload/<?php echo e($backgroundSuffix); ?>_bg_p.svg');">
                                                                <?php if($defaultInspiredBrand): ?>
                                                                    <span class="inspired-brand"><?php echo e(e($defaultInspiredBrand)); ?></span>
                                                                <?php endif; ?>
                                                                <?php if($defaultInspiredTitle): ?>
                                                                    <?php if($defaultInspiredBrand): ?>
                                                                        <br>
                                                                    <?php endif; ?>
                                                                    <span class="inspired-title"><?php echo e(e($defaultInspiredTitle)); ?></span>
                                                                <?php endif; ?>
                                                            </strong>
                                                        </span>
                                                    <?php endif; ?>
                                        ...
                                        <div style="display: flex; flex-wrap: wrap; align-items: center; flex-direction: column;">
                                            <div class="prices">
                                                <div class="price price-final" data-testid="productCardPrice">
                                                    <span class="brx-price-standard" style="display: <?php echo e($showDiscount ? 'inline-block' : 'none'); ?>; padding-top: 4px;">
                                                        <span style="font-weight: 500; color: #000; margin: 0; position: relative; top: 2px; margin-left: -40px !important; text-decoration: line-through;">
                                                            <?php echo e($priceOriginalDisplay); ?>

                                                        </span>
                                                    </span>
                                                    <?php if($productVolumeLabel): ?>
                                                        <span class="productVolume" style="font-size: 11px; font-weight: 800 !important; left: 15px; margin-top: 10px;">
                                                            <?php echo e(e($productVolumeLabel)); ?>

                                                        </span>
                                                    <?php endif; ?>
                                                    <strong style="visibility: visible; <?php echo e($showDiscount ? 'color: #f44336;' : ''); ?> font-weight: 800 !important; position: absolute; right: 15px; font-size: 20px;"><?php echo e($priceCurrentDisplay); ?></strong>
                                                    <span class="brx-price-save" style="display: <?php echo e($showDiscount ? 'inline-block' : 'none'); ?>; font-size: 14px; position: relative; top: 2px; font-weight: 600 !important; <?php echo e($showDiscount ? 'color: #f44336;' : ''); ?>"><?php echo e($discountDisplay); ?></span>
                                                </div>
                                            </div>
                                            <div class="p-tools" style="display: flex; flex-direction: row-reverse; width: 100%; justify-content: space-between; margin-top: 32px; position: absolute;">
                                                <button
                                                    ...
                                                    data-action="buy"
                                                    variant-id="<?php echo e(e($defaultVariantId ?? '')); ?>"
                                                    variant-code="<?php echo e(e($defaultVariantCode ?? '')); ?>"
                                                    data-variant-id="<?php echo e(e($defaultVariantId ?? '')); ?>"
                                                    data-variant-code="<?php echo e(e($defaultVariantCode ?? '')); ?>"
                                                >
                                                    <span>Do košíku</span>
                                                </button>
                                                <a href="<?php echo e(e($defaultDetailUrl)); ?>" class="btn btn-primary" style="font-weight: 500; border-color: #259B63 !important; text-transform: capitalize;">Detail</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                ?>
                                <div class="widget-parameter-wrapper" data-parameter-name="Velikost" data-parameter-id="5" data-parameter-single="true" style="display: <?php echo e($hasMultipleVariants ? 'flex' : 'none'); ?>; justify-content: center; position: absolute; bottom: 80px; width: 100%;">
                                    <?php if(!empty($formattedVariantOptions)): ?>
                                        <ul class="widget-parameter-list" style="list-style: none; display: flex; flex-wrap: nowrap; justify-content: center; gap: 0; padding: 0; margin: 0; overflow-x: auto;">
                                            <?php $__currentLoopData = $formattedVariantOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionIndex => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $optionBrand = null;
                                                    $optionTitle = null;
                                                ?>
                                                ...
                                                ?>
                                                <li
                                                    class="widget-parameter-value <?php echo e($isActiveVariant ? 'active-variant' : ''); ?>"
                                                    style="list-style: none; display: inline-flex; border: none; padding: 0;"
                                                    variant-id="<?php echo e(e($option['variant_id'] ?? '')); ?>"
                                                    variant-image="<?php echo e(e($variantImage)); ?>"
                                                    variant-code="<?php echo e(e($option['variant_code'] ?? '')); ?>"
                                                    variant-price="<?php echo e($variantPriceDisplay !== null ? e($variantPriceDisplay) : ''); ?>"
                                                    variant-original_price="<?php echo e($variantOriginalPriceDisplay !== null ? e($variantOriginalPriceDisplay) : ''); ?>"
                                                    variant-title="<?php echo e(e($option['variant_title'])); ?>"
                                                    variant-stock_level="<?php echo e(e($option['variant_stock_level'] ?? '')); ?>"
                                                    variant-url="<?php echo e(e($variantDetailUrl)); ?>"
                                                    variant-size="<?php echo e(e($variantVolumeDisplay)); ?>"
                                                    variant-discount_value="<?php echo e($variantDiscountDisplay !== null ? e($variantDiscountDisplay) : ''); ?>"
                                                    variant-discount_percentage="<?php echo e(e($option['variant_discount_percentage'] ?? '')); ?>"
                                                    variant-original_price_display="<?php echo e($variantOriginalPriceDisplay !== null ? e($variantOriginalPriceDisplay) : ''); ?>"
                                                    variant-price_display="<?php echo e($variantPriceDisplay !== null ? e($variantPriceDisplay) : ''); ?>"
                                                    variant-inspired_brand="<?php echo e(e($optionBrand ?? '')); ?>"
                                                    variant-inspired_title="<?php echo e(e($optionTitle ?? '')); ?>"
                                                    data-variant-id="<?php echo e(e($option['variant_id'] ?? '')); ?>"
                                                    data-variant-image="<?php echo e(e($variantImage)); ?>"
                                                    data-variant-code="<?php echo e(e($option['variant_code'] ?? '')); ?>"
                                                    data-variant-price="<?php echo e($variantPriceDisplay !== null ? e($variantPriceDisplay) : ''); ?>"
                                                    data-variant-original-price="<?php echo e($variantOriginalPriceDisplay !== null ? e($variantOriginalPriceDisplay) : ''); ?>"
                                                    data-variant-url="<?php echo e(e($variantDetailUrl)); ?>"
                                                    data-variant-volume="<?php echo e(e($variantVolumeDisplay)); ?>"
                                                    data-variant-discount="<?php echo e($variantDiscountDisplay !== null ? e($variantDiscountDisplay) : ''); ?>"
                                                    data-variant-discount-percent="<?php echo e(e($option['variant_discount_percentage'] ?? '')); ?>"
                                                    data-variant-detail-url="<?php echo e(e($variantDetailUrl)); ?>"
                                                    data-variant-mini-image="<?php echo e(e($option['variant_mini_image'] ?? '')); ?>"
                                                    data-variant-inspired-brand="<?php echo e(e($optionBrand ?? '')); ?>"
                                                    data-variant-inspired-title="<?php echo e(e($optionTitle ?? '')); ?>"
                                                >
                                                    <a
                                                        style="cursor: pointer; display: inline-block; min-width: 48px; padding: 5px; font-size: 12px; font-weight: 500; text-decoration: none; text-align: center; border: 1px solid #259B63; border-left-width: <?php echo e($loop->first ? '1px' : '0'); ?>; border-radius: <?php echo e($loop->first && $loop->last ? '24px' : ($loop->first ? '24px 0 0 24px' : ($loop->last ? '0 24px 24px 0' : '0'))); ?>; color: <?php echo e($isActiveVariant ? '#ffffff' : '#000000'); ?>; background: <?php echo e($isActiveVariant ? '#259B63' : '#ffffff'); ?>;"
                                                        title="Velikost: <?php echo e(e($variantVolumeDisplay)); ?>"
                                                    >
                                                        <?php echo e(e($variantVolumeDisplay !== '' ? $variantVolumeDisplay : ($option['variant_title'] ?? 'Varianta'))); ?>
...
<?php /**PATH /var/www/modules/Pim/Resources/views/widgets/embed.blade.php ENDPATH**/ ?>